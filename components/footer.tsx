...
const partners: Partner[] = [
  { name: "BNETD", logo: "/images/logobnet.jpg", url: "https://www.bnetd.ci" },
  {
    ...
    logo: "/images/logouni.jpg",
    url: "https://www.univ-fhb.edu.ci",
  },
  {
    name: "CIRES",
    logo: "/images/partenaire_de_la_CAPEC/LOGO CIRES.jpg",
    url: "https://www.cires.info",
  },
  {
    name: "ACBF",
    logo: "/images/partenaire_de_la_CAPEC/acbflogo.jpg",
    url: "https://www.acbf-pact.org",
  },
];
            ...
            <div className="overflow-x-hidden">
              <div className="flex gap-12 min-w-[600px] justify-center items-center animate-scroll-partners">
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/bankmondiale.jpg"
                    alt="Banque Mondiale"
                    width={100}
                    height={60}
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/BAD.jpg"
                    alt="BAD"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/afdrouge.png"
                    alt="AFD"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/IDRC.jpg"
                    alt="IDRC/CRDI"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/PNUD.jpg"
                    alt="PNUD"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/UGECI.png"
                    alt="UGECI"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/CSCI.png"
                    alt="CSCI"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/MEC.jpg"
                    alt="MEC"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/MFBCI.jpg"
                    alt="MFBCI"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/MCLU.png"
                    alt="MCLU"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/DOUANE.jpg"
                    alt="DOUANE"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/CGECI.jpg"
                    alt="CGECI"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/DGI.jpg"
                    alt="DGI"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/MMPE.jpg"
                    alt="MMPE"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/MFFE.jpg"
                    alt="MFFE"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/UEMOA.jpg"
                    alt="UEMOA"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/CEDEAO.webp"
                    alt="CEDEAO"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/CEA.png"
                    alt="CEA"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/republiqueducongo.webp"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/BCR-logo-1024x543.png"
                    alt="BCR"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/UN-Women.png"
                    alt="UN Women"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/UNICEF.png"
                    alt="UNICEF"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/pam.png"
                    alt="PAM"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/FAO.webp"
                    alt="FAO"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/JAPANFUNDATION.webp"
                    alt="Japan Foundation"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
                  />
                ...
                <div className="flex flex-col items-center px-6 py-4 min-w-[180px]">
                  <Image
                    src="/images/partenaires/jica.webp"
                    alt="JICA"
                    width={100}
                    height={60}
                    className="object-contain mb-2"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10 items-start">
          ...
          <div className="self-center w-full">
            ...
            <form
              ...
              className="flex border border-gray-400 rounded overflow-hidden w-full max-w-md"
            >
              <input
                type="email"
        ...
        <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-sm text-gray-100 text-center">
            ...
            <Link
              ...
              target="_blank"
              className="font-bold text-gray-300 underline hover:text-ci-orange transition-colors duration-300"
            >
              By AITECH-CI
            </Link>
          </div>
